...
- [9]	**Yang J**, Peng B, Wang Y, Ma Z, Zhao Q, Liu L, Jia X, Kumar V, Pan M, Nieber J, Jin Z, & Guan K (2026). Knowledge-guided graph machine learning for spatially distributed prediction of daily discharge and nitrogen export dynamics. ***Water Research***, 296, 125613. [Link](https://www.sciencedirect.com/science/article/abs/pii/S0043135426002964) 
...
- **Manuscript Reviewer** for peer-reviewed journals including *Remote Sensing of Environment*, *Computers and Electronics in Agriculture*, *International Journal of Applied Earth Observation and Geoinformation*, *Journal of Hydrology*, *Journal of Field Robotics*, *Food Chemistry*, *Engineering Applications of Artificial Intelligence*, *Hydrological Processes*, and *Smart Agricultural Technology*, among others.
