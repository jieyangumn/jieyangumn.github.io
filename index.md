...
## News
- **[2026/02]** Our study on knowledge-guided graph machine learning for spatially distributed discharge and nitrogen export prediction has been accepted by [*Water Research*](https://www.sciencedirect.com/journal/water-research/articles-in-press).
...
- [9]	**Yang J**, Peng B, Wang Y, Ma Z, Zhao Q, Liu L, Jia X, Kumar V, Pan M, Nieber J, Jin Z, & Guan K (2026). Knowledge-guided graph machine learning for spatially distributed prediction of daily discharge and nitrogen export dynamics. ***Water Research***. Accepted.
